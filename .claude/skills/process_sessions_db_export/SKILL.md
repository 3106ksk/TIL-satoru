...
1.  **Identify the Input CSV**: Locate the raw CSV file (often nested under `notion_exports`, e.g., `notion_exports/ExportBlock-.../Sessions/Sessions DB*.csv`).
...
2.  **Execute Script**:
    -   Run the following command (adjusting paths and dates):
        ...
        python3 /Users/310tea/Documents/Learning_log/.claude/skills/process_sessions_db_export/scripts/process_sessions.py \
          ...
          "YYYY-MM-DD" \
          "YYYY-MM-DD" \
          "/Users/310tea/Documents/Learning_log/Sessions"
        ```
    -   *Note*: The output directory is fixed to `/Users/310tea/Documents/Learning_log/Sessions` unless specified otherwise.
...
**Follow-up**:
-   `rm "/Users/310tea/Documents/Learning_log/notion_exports/ExportBlock-1234/Sessions/Sessions DB Export.csv"`
