...
4.  **Create Files**:
    -   **Weekly Strategy Context (JSON)**:
        -   Path: `/Users/310tea/Documents/Learning_log/weekly_strategies/YYYY-MM-DD.json`
        -   Content: `theme`, `target_hours`, `experiment` (action, success_definition), `risks`, `success_criteria`.
    -   **Risk Assessment (Markdown)**:
        -   Path: `/Users/310tea/Documents/Learning_log/risk_assessments/YYYY-MM-DD.md`
...
2.  **Create File**:
    -   Path: `/Users/310tea/Documents/Learning_log/community_reports/YYYY-MM-DD_report.md`
